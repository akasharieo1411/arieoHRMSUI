...
// icons
const Swipe = Loadable(lazy(() => import('../views/swipe/Swipe')));
const Organisation = Loadable(lazy(() => import('../views/peoples/OrgChart')));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/swipe-details', exact: true, element: <Swipe /> }, 
      { path: '/OrgChart', exact: true, element: <Organisation /> }, 
